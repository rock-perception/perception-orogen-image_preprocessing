...
::base::samples::Pointcloud DepthImage2Pointcloud::createPointcloud(::RTT::extras::ReadOnlyPointer< ::base::samples::DistanceImage > const & frame_sample, ::RTT::extras::ReadOnlyPointer< ::base::samples::frame::Frame > const & color_frame)
{
